...
@section('title', 'Partner Bookings')
...
<div class="space-y-8">
    ...
    <div data-aos="fade-up">
        <h1 class="text-2xl font-bold text-gray-900">Partner Bookings</h1>
        <p class="mt-1 text-gray-500">Kelola pemesanan kendaraan dari pelanggan.</p>
    </div>
    ...
    <div class="flex flex-wrap gap-2" data-aos="fade-up" data-aos-delay="100">
        ...
        @foreach($tabs as $value => $label)
            <a href="{{ route('partner.bookings', array_merge(request()->except('status'), $value ? ['status' => $value] : [])) }}"
    ...
    <div class="space-y-4" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="flex-1">
                            <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Penyewa: <span class="font-medium text-gray-700">{{ $booking->user->name ?? '-' }}</span></p>
                                </div>
                                @php
                                    $statusColors = [
        ...
        @else
            <div class="rounded-2xl border border-gray-100 bg-white p-12 text-center shadow-sm">
                ...
                <a href="{{ route('partner.bookings') }}" class="mt-4 inline-flex items-center gap-2 rounded-xl bg-primary-500 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-primary-600">
                    Lihat Semua Booking
                </a>
            </div>
        @endif
